...
[Back To The Setup] TODO
- [Forward to Python] TODO
...
1.  The shell is a really powerful way of interacting with your
...
2.  Often, your programs must communicate with the user or other computers.
    A CLI is a very simple way for you to accomplish this.

3.  Because of this, it is very common to encounter the shell and
...
**Hint:** Instead of writing out the `boot-camps` in full, start to spell it
and then hit the `TAB` button (the full name should auto-complete).
...
to exit.  The manual is written as a reference for experts.  Beginners
are encouraged to search for examples on the internet.
